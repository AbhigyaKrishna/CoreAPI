...
public class ParticleUtils {
     ...
     * <p>
     *
     * @param packets Packets that should be sent to the player
     * @param player  Target {@link Player} that should receive the packets
     */
    public static void sendBulk(Collection<Object> packets, Player player) {
        Object connection = ParticleReflectionUtils.PLAYER_CONNECTION_CACHE.getConnection(player);
     ...
     * <p>
     *
     * @param packets Packets that should be sent to the players
     * @param players Target {@link Player Players} that should receive the packets
     */
     ...
     * <p>
     *
     * @param packets Packets that should be sent
     */
     ...
     * <p>
     *
     * @param builders {@link ParticleBuilder ParticleBuilders} that should be converted and sent to the player
     * @param player   Target {@link Player} that should receive the packets
     */
     ...
     * <p>
     *
     * @param builders {@link ParticleBuilder ParticleBuilders} that should be converted and sent to the players
     * @param players  Target {@link Player Players} that should receive the packets
     */
