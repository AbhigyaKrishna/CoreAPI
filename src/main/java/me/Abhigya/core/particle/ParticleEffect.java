...
public enum ParticleEffect {
     ...
     * <p>
     *
     * @param fieldNameMapper {@link IntFunction} to map the version to the name of the
     *                        respective particle.
     ...
     * <p>
     *
     * @param propertyType {@link PropertyType} that should be searched.
     ...
     * <p>
     *
     * @param data {@link ParticleData} that should that should be checked.
     ...
     * <p>
     *
     * @param color {@link ParticleColor} data that should be checked
     ...
     * <p>
     *
     * @param location {@link Location} at which the particle should be displayed
     * @param color    {@link ParticleColor} the particle should have
     ...
     * @param location {@link Location} at which the particle should be displayed
     * @param color    {@link ParticleColor} the particle should have
     * @param filter   {@link Predicate} to filter out specific {@link Player Players}
     */
     ...
     * @param location {@link Location} at which  the particle should be displayed
     * @param color    {@link ParticleColor} the particle should have
     * @param players  {@link Collection} of players that should receive the particle packet
     */
     ...
     *
     * @param location {@link Location} at which the particle should be displayed
     * @param vector   Velocity at which the particle should fly off
     * @param speed    Multiplier of the particle velocity
     * @param amount   Amount of particles that should be displayed
     * @param data     {@link ParticleData} the particle should have
     * @param players  List of players that should receive the particle packet
     */
     ...
     *
     * @param location {@link Location} at which the particle should be displayed
     * @param offsetX  OffsetX data of the particle
     * @param offsetY  OffsetY data of the particle
     * @param offsetZ  OffsetZ data of the particle
     * @param speed    Multiplier of the particle velocity
     * @param amount   Amount of particles that should be displayed
     * @param data     {@link ParticleData} the particle should have
     * @param players  List of players that should receive the particle packet
