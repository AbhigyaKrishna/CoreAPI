...
public class Vector3D implements Vector {
    ...
    /**
     * Creates and returns a new {@link Vector2D} by specifying the components to provide, following
     ...
     *     will construct the Vector2D with its x component having the same value as the y component
     *     of this vector. Providing <strong>1</strong>, will construct the Vector2D with its x
     *     component having the same value as the z component of this vector.
     * @param y Providing <strong>-1</strong>, will construct the Vector2D with its y component
     *     having the same value as the x component of this vector. Providing <strong>0</strong>,
     *     will construct the Vector2D with its y component having the same value as the y component
     *     of this vector. Providing <strong>1</strong>, will construct the Vector2D with its y
     *     component having the same value as the z component of this vector.
     * @return 2D version
     */
                    ...
                    79 * hashcode
                            + (int)
                                    (Float.floatToIntBits(this.z)
                                            ^ (Float.floatToIntBits(this.z) >>> 32));
