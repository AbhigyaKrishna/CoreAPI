...
public class TargetUtils {
    ...
    /**
     * Gets a target entity located an the provided world, from a {@link Ray} and a
     * range, using the specified {@link TargetFilter} for filtering.
     * <p>
     * Also it is guaranteed that the closest target entity will be returned.
     * <p>
     *
     * @param ray    Ray
     * @param world  World target entities resides in
     * @param range  Range that determines how distant an entity can be to be
     *               considered as a target. {@link Integer#MAX_VALUE} can be used
     *               to consider all the entities residing in the world, but note
     *               that the performance might be affected because of more entities
     *               will be considered.
     * @param filter Filter
    ...
    /**
     * Gets a target entity located an the provided world, from a {@link Ray} and a
     * range, using a {@link TargetFilterClass} with the specified {@code clazz} for
     ...
     * @param world World target entities resides in.
     * @param range Range that determines how distant an entity can be to be
     *              considered as a target. {@link Integer#MAX_VALUE} can be used to
     *              consider all the entities residing in the world, but note that
     *              the performance might be affected because of more entities will
     *              be considered.
    ...
    /**
     * Gets a target entity located an the provided world, from a {@link Ray} and a
     * range, using a {@link TargetFilterType} with the specified {@code type} for
    ...
    /**
     * Gets a target entity of the desired {@link Player} located in the world of
     * the player, within a range, using the specified {@link TargetFilter} for
     * filtering.
     * <p>
     * Also it is guaranteed that the closest target entity will be returned.
     * <p>
     *
     * @param player Player
     * @param range  the range that determines how distant an entity can be to be
     *               considered as a target. {@link Integer#MAX_VALUE} can be used
     *               to consider all the entities residing in the world, but note
     *               that the performance might be affected because of more entities
     *               will be considered.
    ...
    /**
     * Gets a target entity of the desired {@link Player} located in the world of
     * the player, within a range, using a {@link TargetFilterClass} with the
     * specified {@code clazz} for filtering entities by class.
     * <p>
     * Also it is guaranteed that the closest target entity will be returned.
     * <p>
     *
    ...
    /**
     * Gets a target entity of the desired {@link Player} located in the world of
     * the player, using a {@link TargetFilterType} with the specified {@code type}
     * for filtering entities by type.
     * <p>
     * Also it is guaranteed that the closest target entity will be returned.
     * <p>
     *
    ...
    /**
     * Gets a target player of the desired {@link Player} located in the world of
     * the player. This uses a {@link TargetFilterType} with the
     * {@link EntityType#PLAYER} for filtering.
     * <p>
     * Also it is guaranteed that the closest target player will be returned.
     * <p>
     *
     * @param player Player
     * @param range  Range that determines how distant a player can be to be
     *               considered as a target. {@link Integer#MAX_VALUE} can be used
     *               to consider all the entities residing in the world, but note
     *               that the performance might be affected because of more entities
     *               will be considered.
    ...
    /**
     * An implementation of {@link TargetFilter} to avoid a specified {@link Player}
     * to be considered when looking for a target entity.
     */
    ...
    /**
     * A {@link TargetFilter} that delegates to an ordered array of other filters.
     * Delegation for a filter stops if a filter returns {@code false}.
     */
