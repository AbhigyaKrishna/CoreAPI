 ...
 *
 * <p>The values of {@link #length()}, {@link #lengthSquared()}, {@link #normalize()} and {@link
 * #hashCode()} are cached for a better performance.
 */
public class Vector2D implements Vector {
    ...
    /**
     * Creates and returns a new {@link Vector3D} by specifying the components to provide, following
     * the rules explain below:
     *
     ...
     *     having the same value as the x component of this vector. Providing <strong>0</strong>,
     *     will construct the Vector3D with its x component having the same value as the y component
     *     of this vector. Providing <strong>1</strong>, will construct the Vector3D with its x
     *     being 0.
     * @param y Providing <strong>-1</strong>, will construct the Vector3D with its y component
     *     having the same value as the x component of this vector. Providing <strong>0</strong>,
     *     will construct the Vector3D with its y component having the same value as the y component
     *     of this vector. Providing <strong>1</strong>, will construct the Vector3D with its y
     *     being 0.
     * @param z Providing <strong>-1</strong>, will construct the Vector3D with its z component
     *     having the same value as the x component of this vector. Providing <strong>0</strong>,
     *     will construct the Vector3D with its z component having the same value as the y component
     *     of this vector. Providing <strong>1</strong>, will construct the Vector3D with its z
     *     being 0.
    ...
    public Location toLocation(
            final World world, final double z, final float yaw, final float pitch) {
                    ...
                    79 * hashcode
                            + (int)
                                    (Float.floatToIntBits(this.x)
                                            ^ (Float.floatToIntBits(this.x) >>> 32));
            this.hashcode =
                    79 * hashcode
                            + (int)
                                    (Float.floatToIntBits(this.y)
                                            ^ (Float.floatToIntBits(this.y) >>> 32));
    ...
    public boolean equals(final Object obj) {
        ...
        return (this.x_bits == other.x_bits) && (this.y_bits == other.y_bits);
    }
