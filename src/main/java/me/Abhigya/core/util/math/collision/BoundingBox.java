...
public class BoundingBox {
    ...
    public static final BoundingBox ZERO =
            new BoundingBox(new Vector(0D, 0D, 0D), new Vector(0D, 0D, 0D));
    public static final BoundingBox BLOCK =
            new BoundingBox(new Vector(0D, 0D, 0D), new Vector(1D, 1D, 1D));
    ...
    public BoundingBox(
            ...
            Double maximum_z) {
        this(
                new Vector(minimum_x, minimum_y, minimum_z),
                new Vector(maximum_x, maximum_y, maximum_z));
    }
