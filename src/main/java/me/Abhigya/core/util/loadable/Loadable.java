package me.Abhigya.core.util.loadable;
...
//					System.out.println ( "Loadable: load: destiny_section = " + destiny_section );
                    if (destiny_section != null) {
                        getted = destiny_section.get(options.key(), null);
                    } else {
                        getted = section.get(options.key());
//						System.out.println ( "Loadable: load: getted = " + getted );
//						System.out.println ( "Loadable: load: options.key ( ) = " + options.key ( ) );
//						System.out.println ( "Loadable: load: section keys = " + section.getKeys ( false ) );
                    }
                }
...
//					System.out.println ( "entry.getType().isAssignableFrom(getted.getClass()) = " + entry.getType().isAssignableFrom(getted.getClass()) );
//					System.out.println ( "DataType.fromClass(entry.getType()) = " + DataType.fromClass(entry.getType()) );
//					System.out.println ( "DataType.fromClass(getted.getClass()) = " + DataType.fromClass(getted.getClass()) );
//					System.out.println ( "DataType.fromClass(entry.getType()) == DataType.fromClass(getted.getClass()) = " + ( DataType.fromClass(entry.getType()) == DataType.fromClass(getted.getClass()) ) );
