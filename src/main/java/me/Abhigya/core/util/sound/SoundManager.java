package me.Abhigya.core.util.sound;
...
public enum SoundManager {
    ...
    BLOCK_ENDERCHEST_OPEN("BLOCK_ENDERCHEST_OPEN", "BLOCK_ENDER_CHEST_OPEN"),
    ...
    SoundManager(String... versionDependentNames) {
    ...
    public static Sound match(String name) {
        ...
        return valueOf(name.toUpperCase()).asBukkit();
    }
}
