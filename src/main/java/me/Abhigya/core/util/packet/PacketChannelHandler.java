...
public final class PacketChannelHandler {
    ...
    private static final Map<Priority, Set<RegisteredPacketListener>> PACKET_LISTENERS =
            new HashMap<>();

    /* initialize channels handler by registering a player injector instance */
    static {
        Bukkit.getPluginManager()
                .registerEvents(new PlayerInjector(), CoreAPI.getInstance().getHandlingPlugin());
    }
    ...
    public static void addPacketListener(
            final String packet_name, final Priority priority, final PacketListener listener) {
    ...
    /**
     * Reflection class used by the {@link PlayerInjector} for getting the channel of a {@link
     * Player}.
     */
