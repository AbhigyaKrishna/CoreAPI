...
public class ReflectionCache {
    ...
    static {
        ...
        ENTITY_ARMOR_STAND =
                ClassReflection.getNmsClass("EntityArmorStand", "world.entity.decoration");
        PACKET_PLAY_OUT_ENTITY_EQUIPMENT =
                ClassReflection.getNmsClass(
                        "PacketPlayOutEntityEquipment", "network.protocol.game");
        PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING =
                ClassReflection.getNmsClass(
                        "PacketPlayOutSpawnEntityLiving", "network.protocol.game");
        PACKET_PLAY_OUT_ENTITY_VELOCITY =
                ClassReflection.getNmsClass("PacketPlayOutEntityVelocity", "network.protocol.game");
        PACKET_PLAY_OUT_ENTITY_DESTROY =
                ClassReflection.getNmsClass("PacketPlayOutEntityDestroy", "network.protocol.game");
        PACKET_PLAY_OUT_ENTITY_METADATA =
                ClassReflection.getNmsClass("PacketPlayOutEntityMetadata", "network.protocol.game");
        PACKET_PLAY_OUT_ENTITY_TELEPORT =
                ClassReflection.getNmsClass("PacketPlayOutEntityTeleport", "network.protocol.game");
        PACKET_PLAY_OUT_ENTITY_HEAD_ROTATION =
                ClassReflection.getNmsClass(
                        "PacketPlayOutEntityHeadRotation", "network.protocol.game");
        ...
        try {
            ENTITY_ARMOR_STAND_CONSTRUCTOR =
                    ConstructorReflection.get(
                            ENTITY_ARMOR_STAND, WORLD, double.class, double.class, double.class);
            CHAT_MESSAGE_CONSTRUCTOR =
                    ConstructorReflection.get(CHAT_MESSAGE, String.class, Object[].class);
            PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING_CONSTRUCTOR =
                    ConstructorReflection.get(PACKET_PLAY_OUT_SPAWN_ENTITY_LIVING, ENTITY_LIVING);
            PACKET_PLAY_OUT_ENTITY_DESTROY_CONSTRUCTOR =
                    ConstructorReflection.get(PACKET_PLAY_OUT_ENTITY_DESTROY, int[].class);
            ...
            PACKET_PLAY_OUT_ENTITY_TELEPORT_CONSTRUCTOR =
                    ConstructorReflection.get(PACKET_PLAY_OUT_ENTITY_TELEPORT, ENTITY);

            SET_INVISIBLE = MethodReflection.get(ENTITY, "setInvisible", boolean.class);
            SET_CUSTOM_NAME_VISIBLE =
                    MethodReflection.get(ENTITY_ARMOR_STAND, "setCustomNameVisible", boolean.class);
            try {
            ...
            SET_BASE_PLATE =
                    MethodReflection.get(ENTITY_ARMOR_STAND, "setBasePlate", boolean.class);
            try {
                SET_NO_GRAVITY =
                        MethodReflection.get(ENTITY_ARMOR_STAND, "setGravity", boolean.class);
            } catch (NoSuchMethodException e) {
                SET_NO_GRAVITY =
                        MethodReflection.get(ENTITY_ARMOR_STAND, "setNoGravity", boolean.class);
            }
            SET_LOCATION =
            ...
            try {
                SET_CUSTOM_NAME =
                        MethodReflection.get(ENTITY_ARMOR_STAND, "setCustomName", String.class);
            } catch (NoSuchMethodException e) {
                SET_CUSTOM_NAME =
                        MethodReflection.get(
                                ENTITY_ARMOR_STAND, "setCustomName", I_CHAT_BASE_COMPONENT);
            }
            ...
            if (ClassReflection.nmsClassExist("EnumItemSlot", "world.entity")) {
                try {
                    PACKET_PLAY_OUT_ENTITY_EQUIPMENT_CONSTRUCTOR =
                            ConstructorReflection.get(
                                    PACKET_PLAY_OUT_ENTITY_EQUIPMENT,
                                    int.class,
                                    ClassReflection.getNmsClass("EnumItemSlot", "world.entity"),
                                    ITEM_STACK);
                } catch (NoSuchMethodException e) {
                    PACKET_PLAY_OUT_ENTITY_EQUIPMENT_CONSTRUCTOR =
                            ConstructorReflection.get(
                ...
                PACKET_PLAY_OUT_ENTITY_EQUIPMENT_CONSTRUCTOR =
                        ConstructorReflection.get(
                                PACKET_PLAY_OUT_ENTITY_EQUIPMENT, int.class, int.class, ITEM_STACK);
            }
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        }
