...
public class MethodReflection {
    ...
    public static Method get(
            Class<?> clazz, String name, boolean declared, Class<?>... parameter_types)
            throws NoSuchMethodException, SecurityException {
        return declared
                ? clazz.getDeclaredMethod(name, parameter_types)
                : clazz.getMethod(name, parameter_types);
    }

    /**
     * Gets the method with the provided name (<strong>No matter if declared or not</strong>) from
     * the provided class.
     *
     * <p>
     *
    ...
    /**
     * Gets the method with the provided name from the provided class, and sets it accessible.
     *
     * <p>
     *
     * @param clazz the class that holds the method
     ...
     *     </ul>
     */
    public static Method getAccessible(
            Class<?> clazz, String name, boolean declared, Class<?>... parameter_types)
            throws NoSuchMethodException, SecurityException {
    ...
    /**
     * Gets the method with the provided name (<strong>No matter if declared or not</strong>) from
     * the provided class, and sets it accessible.
     *
     * <p>
     *
     * @param clazz the class that holds the method
    ...
    /**
     * Invokes the underlying method represented by the provided {@code Method}, on the specified
     ...
     * @return the result of dispatching the method represented by this object on {@code object}
     ...
     *     of a subclass or implementor thereof); if the number of actual and formal parameters
     *     differ; if an unwrapping conversion for primitive arguments fails; or if, after possible
     *     unwrapping, a parameter value cannot be converted to the corresponding formal parameter
     ...
     * method invocation conversions as necessary.
     *
     * <p><strong>Note that the method is set as accessible before invoking</strong>.
     *
     * <p>
     *
     * @param method the method to invoke
    ...
    /**
     * Invokes the underlying method represented by the provided {@code name}, on the specified
     * object with the specified parameters. Individual parameters are automatically unwrapped to
     * match primitive formal parameters, and both primitive and reference parameters are subject to
     * method invocation conversions as necessary.
     *
