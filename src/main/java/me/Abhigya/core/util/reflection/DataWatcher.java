...
import me.Abhigya.core.util.reflection.resolver.ConstructorResolver;
import me.Abhigya.core.util.reflection.resolver.FieldResolver;
import me.Abhigya.core.util.reflection.resolver.MethodResolver;
import me.Abhigya.core.util.reflection.resolver.ResolverQuery;
import me.Abhigya.core.util.reflection.resolver.minecraft.NMSClassResolver;
...
public class DataWatcher {
    ...
    static Class<?> ChunkCoordinates =
            nmsClassResolver.resolveSilent("ChunkCoordinates", "world.level.ChunkCoordinates");
    static Class<?> BlockPosition =
            nmsClassResolver.resolveSilent("BlockPosition", "core.BlockPosition");
    static Class<?> Vector3f = nmsClassResolver.resolveSilent("Vector3f", "core.Vector3f");
    static Class<?> DataWatcher =
            nmsClassResolver.resolveSilent("DataWatcher", "network.syncher.DataWatcher");
    ...
    public static Object setValue(
            Object dataWatcher, int index, Object dataWatcherObject /*1.9*/, Object value)
            throws ReflectiveOperationException {
        if (CoreAPI.getInstance().getServerVersion().isOlder(Version.v1_9_R1)) {
    ...
    public static Object setValue(
            ...
            int index,
            Object value,
            FieldResolver dataWatcherObjectFieldResolver /*1.9*/,
            String... dataWatcherObjectFieldNames /*1.9*/)
            throws ReflectiveOperationException {
        if (CoreAPI.getInstance().getServerVersion().isOlder(Version.v1_9_R1)) {
            return V1_8.setValue(dataWatcher, index, value);
        } else {
            Object dataWatcherObject =
                    dataWatcherObjectFieldResolver
                            .resolve(dataWatcherObjectFieldNames)
                            .get(null /*Should be a static field*/);
            return V1_9.setValue(dataWatcher, dataWatcherObject, value);
        }
    }

    @Deprecated
    public static Object getValue(DataWatcher dataWatcher, int index)
            throws ReflectiveOperationException {
        if (CoreAPI.getInstance().getServerVersion().isOlder(Version.v1_9_R1)) {
    ...
    public static Object getValue(Object dataWatcher, int index, Object dataWatcherObject /*1.9*/)
            throws ReflectiveOperationException {
        if (CoreAPI.getInstance().getServerVersion().isOlder(Version.v1_9_R1)) {
    ...
    public static int getValueType(Object value) {
        ...
        if (value instanceof Number) {
            ...
            type = 5;
                ...
                && (value.getClass().equals(ChunkCoordinates)
                        || value.getClass().equals(BlockPosition))) {
            type = 6;
    ...
    public static class V1_9 {
        ...
        static Class<?> DataWatcherItem =
                nmsClassResolver.resolveSilent(
                        "DataWatcher$Item", "network.syncher.DataWatcher$Item"); // >= 1.9 only
        static Class<?> DataWatcherObject =
                nmsClassResolver.resolveSilent(
                        "DataWatcherObject", "network.syncher.DataWatcherObject"); // >= 1.9 only
        ...
        public static Object newDataWatcherItem(Object dataWatcherObject, Object value)
            ...
            return DataWatcherItemConstructorResolver.resolveFirstConstructor()
                    .newInstance(dataWatcherObject, value);
        }

        public static Object setItem(
                Object dataWatcher, int index, Object dataWatcherObject, Object value)
                throws ReflectiveOperationException {
        ...
        public static Object setItem(Object dataWatcher, int index, Object dataWatcherItem)
            ...
            Map<Integer, Object> map =
                    (Map<Integer, Object>)
                            DataWatcherFieldResolver.resolveByLastTypeSilent(Map.class)
                                    .get(dataWatcher);
        ...
        //		public static Object getValue(Object dataWatcher, int index) throws
        // ReflectiveOperationException {
        //			Map<Integer, Object> map = (Map<Integer, Object>)
        // DataWatcherFieldResolver.resolve("c").get(dataWatcher);
        //			return map.get(index);
        //		}

        public static Object getItem(Object dataWatcher, Object dataWatcherObject)
                throws ReflectiveOperationException {
            return DataWatcherMethodResolver.resolve(new ResolverQuery("c", DataWatcherObject))
        ...
        public static Object getValue(Object dataWatcher, ValueType type)
                throws ReflectiveOperationException {
        ...
        public static int getItemIndex(Object dataWatcher, Object item)
                throws ReflectiveOperationException {
        ...
        public static void setItemValue(Object item, Object value)
                throws ReflectiveOperationException {
        ...
        public enum ValueType {
            ...
            // TODO: Add EntityWither#bv (Integer) - (DataWatcherObject<Integer>[] bv, seems to be
            // an array of {a, b, c})
            ...
            ValueType(String className, String... fieldNames) {
                try {
                    this.type =
                            new FieldResolver(nmsClassResolver.resolve(className))
                                    .resolve(fieldNames)
                                    .get(null);
            ...
            ValueType(String className, int index, int offset) {
                ...
                try {
                    ...
                    this.type =
                            new FieldResolver(clazz).resolveIndex(firstObject + offset).get(null);
    ...
    public static class V1_8 {
        ...
        static Class<?> WatchableObject =
                nmsClassResolver.resolveSilent(
                        "WatchableObject", "DataWatcher$WatchableObject"); // <=1.8 only
        ...
        public static Object newWatchableObject(int type, int index, Object value)
                throws ReflectiveOperationException {
            if (WatchableObjectConstructorResolver == null) {
                WatchableObjectConstructorResolver = new ConstructorResolver(WatchableObject);
            }
            return WatchableObjectConstructorResolver.resolve(
        ...
        public static Object getValue(Object dataWatcher, int index)
                throws ReflectiveOperationException {
            Map map = (Map) DataWatcherFieldResolver.resolveByLastType(Map.class).get(dataWatcher);
