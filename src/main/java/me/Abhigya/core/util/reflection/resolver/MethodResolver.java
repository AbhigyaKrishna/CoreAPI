package me.Abhigya.core.util.reflection.resolver;

import me.Abhigya.core.util.reflection.general.MethodReflection;
import me.Abhigya.core.util.reflection.resolver.wrapper.MethodWrapper;
...
public class MethodResolver extends MemberResolver<Method> {
        ...
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            for (String s : signatures) {
                if (s.equals(methodSignature)) {
                    return MethodReflection.setAccessible(method);
                }
            }
        }
        return null;
    ...
    @Override
    public Method resolveIndex(int index)
            throws IndexOutOfBoundsException, ReflectiveOperationException {
        return MethodReflection.setAccessible(this.clazz.getDeclaredMethods()[index]);
    }
