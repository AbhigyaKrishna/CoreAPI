...
public class FieldReflection {
     ...
     * @return {@code Field} object of the provided class specified by {@code name}
    ...
    /**
     * Gets the field with the provided name from the provided class. (<strong>No matter if declared
     * or not</strong>).
     *
     * <p>
     *
    ...
    /**
     * Gets the field with the provided name from the provided class, and sets it accessible.
     *
     * <p>
     *
     * @param clazz Class that holds the field
    ...
    /**
     * Gets the field with the provided name from the provided class, and sets it accessible.
     * (<strong>No matter declared or not</strong>).
     *
     * <p>
     *
     * @param clazz Class that holds the field
    ...
    /**
     * Returns the value of the field represented by the field with the provided name, on the
     * specified object. The value is automatically wrapped in an object if it has a primitive type.
     *
     * <p>
     *
    ...
    /**
     * Returns the value of the field represented by the field with the provided name (<strong>No
     * matter if declared or not</strong>), on the specified object. The value is automatically
    ...
    /**
     * Sets the field represented by the field with the provided name, on the specified object
     * argument to the specified new value. The new value is automatically unwrapped if the
    ...
    /**
     * Sets the field represented by the field with the provided name (<strong>No matter if declared
     * or not</strong>), on the specified object argument to the specified new value. The new value
     ...
     *
     * <p><strong> Note that the if the field is <code>final</code>, it will set as "not final", so
     * that the value can be changed. </strong>
     *
     * <p>
     *
    ...
    /**
     * Returns the classes of the types of a parameterized field, like {@link Collection} or {@link
     * Map}.
     *
     * <p>Examples: - {@code getParameterizedTypesClasses(Collection<Integer>)} (of a collection
     * field in this case) will return: [java.lang.Integer] - {@code
     * getParameterizedTypesClasses(Map<Integer, String>)} (of a map field in this case) will
