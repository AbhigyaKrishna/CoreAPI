...
public class ConstructorReflection {
     ...
     * public constructor of the class represented by the provided {@code Class}
     * object. The {@code parameter_types} parameter is an array of
    ...
    /**
     * Returns a {@code Constructor} object (<strong>No matter if declared or
     * not</strong>) that reflects the specified public constructor of the class
     * represented by the provided {@code Class} object. The {@code parameter_types}
     * parameter is an array of {@code Class} objects that identify the
     * constructor's formal parameter types, in declared order.
     * <p>
     *
     * @param clazz           Class that holds the constructor
     * @param parameter_types Parameter array
     * @return {@code Constructor} object that matches the specified
     ...
     * constructor of the class represented by the provided {@code Class} object.
     * The {@code parameter_types} parameter is an array of {@code Class} objects
     ...
     *                        constructor call; values of primitive types are
     *                        wrapped in a wrapper object of the appropriate type
     *                        (e.g. a {@code float} in a {@link java.lang.Float
     *                        Float})
...
//	}
     ...
     * declaring class, with the specified initialization parameters. Individual
     ...
     *
     * @param clazz           Class that holds the constructor
     * @param parameter_types Parameters of the constructor, used for matching
     *                        it
     * @param arguments       Array of objects to be passed as arguments to the
     *                        constructor call; values of primitive types are
     *                        wrapped in a wrapper object of the appropriate type
