...
public class ConfigurableItemStack implements Configurable {
    ...
    /**
     * Construct a {@link ConfigurableItemStack} getting the default values from the given {@link
     * ItemStack}.
     *
     * <p>
     *
     ...
     */
    public ConfigurableItemStack(
            String type, int size, String name, List<String> lore, short data) {
        this.type = type;
        this.size = size;
        this.name = name;
        this.lore = lore;
    ...
    public ItemStack toItemStack() {
        ...
        return builder.withDisplayName(StringUtils.translateAlternateColorCodes(getName()))
                ...
                .applyTo(
                        new ItemStack(
                                MaterialUtils.getRightMaterial(Material.valueOf(getType())),
                                getSize(),
                                getData()));
    }
