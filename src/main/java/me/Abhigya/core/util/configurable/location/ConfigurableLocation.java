package me.Abhigya.core.util.configurable.location;

import me.Abhigya.core.util.Initializable;
...
public class ConfigurableLocation extends Location implements Configurable, Initializable {
    ...
    public int save( ConfigurationSection section ) {
        return ( YamlUtils.setNotEqual( section, WORLD_UID_KEY, ( getWorld( ) != null ? getWorld( ).getUID( ).toString( ) : "" ) ) ? 1 : 0 )
