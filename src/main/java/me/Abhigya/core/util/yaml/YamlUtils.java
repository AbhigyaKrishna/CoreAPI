...
public class YamlUtils {
    ...
    /**
     * Sets the specified path to the given value if and only if it is not already
     * set.
     * <p>
     ...
     * {@link Configuration} or {@link ConfigurationSection}, please use
    ...
    /**
     * Sets the specified path to the given value if and only if it the value at the
     * provided path is not the same as {@code value}.
     * <p>
     * If value is null, the entry will be removed. Any existing entry will be
     * replaced, regardless of what the new value is.
     * <p>
    ...
    /**
     * Creates an empty {@link ConfigurationSection} within the specified
     * {@link ConfigurationSection} if and only if there is no another section with
     * the same name as the provided.
     * <p>
     *
    ...
    /**
     * Gets the {@link ConfigurationSection} within the desired
     * {@link ConfigurationSection} (sub-sections of the desired section).
     * <p>
     *
     * @param section {@link ConfigurationSection} where the sub-sections are
     *                stored
    ...
    /**
     * Replaces the desired character that is used as path separator by the
     * specified {@code alt_char}.
     * <p>
     *
    ...
    /**
     * Replaces the common path separator {@literal '.'} by the specified
     * {@code alt_char}.
     * <p>
     *
