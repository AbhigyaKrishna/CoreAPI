...
public class YamlConfigurationCommentsOptions extends YamlConfigurationOptions {
    ...
    /**
     * Sets the comment of the given path that will be applied to the top of the
     * given path.
     * <p>
     * This comment will be applied directly at the top of the given path. It is
     * not required a new line (\n) at the end of the comment as it will
     * automatically be applied, but you may include one if you wish for extra
     * spacing.
     * <p>
     * Null is a valid value which will indicate that no comment is to be
     * applied at the top of the given path.
     * <p>
     *
     ...
     * spacing.
     * <p>
     * Null/Empty comment is a valid value which will indicate that no comment
     * is to be applied at the top of the given path.
     * <p>
     *
...
//		return isCommented ( section , path ) ? comments.get ( section.getCurrentPath ( ) ).get ( path ) : null;
    ...
    /**
     * Gets whether the comments of the path should be inserted at the top of
     * the paths when saving the configuration.
     * <p>
     *
    ...
    /**
     * Sets whether or not the comments should by copied to the top of the paths
