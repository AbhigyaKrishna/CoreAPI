...
public class GameRuleDisableDaylightCycle extends GameRule {
    ...
    /**
     * Construct a new {@link GameRule} that disables the daylight cycle of the worlds. With the
     * default final time {@link GameRuleDisableDaylightCycle#DEFAULT_FINAL_TIME}
     */
    ...
    /**
     * Construct a new {@link GameRule} that disables the daylight cycle of the worlds.
     *
     * <p>
     *
