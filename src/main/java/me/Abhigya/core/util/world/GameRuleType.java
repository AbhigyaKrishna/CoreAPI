        ...
        if ( getPresentationMode( ) == GameRulePresentationMode.ORDINARY ) {
            try {
                ...
                switch ( getDataType( ) ) {
                    case BOOLEAN:
                    default:
                        world.setGameRule( (org.bukkit.GameRule< Boolean >) org.bukkit.GameRule.getByName( getName( ) ),
                                (Boolean) value );
                        break;

                    case INTEGER:
                        world.setGameRule( (org.bukkit.GameRule< Integer >) org.bukkit.GameRule.getByName( getName( ) ),
                                (Integer) value );
                        break;
                }
            } catch ( ClassNotFoundException ex ) {
