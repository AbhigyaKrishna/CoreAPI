...
package me.Abhigya.core.util.npc.npclib;

import me.Abhigya.core.util.npc.npclib.NPCLibOptions;
import me.Abhigya.core.util.npc.npclib.NPCLibOptions.MovementHandling;
import me.Abhigya.core.util.npc.npclib.api.NPC;
import me.Abhigya.core.util.npc.npclib.api.utilities.Logger;
import me.Abhigya.core.util.npc.npclib.listeners.*;
import me.Abhigya.core.util.npc.npclib.metrics.NPCLibMetrics;
...
public final class NPCLib {
    ...
    private NPCLib(JavaPlugin plugin, MovementHandling moveHandling) {
        ...
        try {
            npcClass = Class.forName("me.Abhigya.core.util.npc.npclib.nms." + versionName + ".NPC_" + versionName);
