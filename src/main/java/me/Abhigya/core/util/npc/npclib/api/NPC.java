...
package me.Abhigya.core.util.npc.npclib.api;
...
public interface NPC {
     ...
     */
    me.Abhigya.core.util.npc.npclib.api.NPC removeText(Player player);
     ...
     * @return object instance
     */
    me.Abhigya.core.util.npc.npclib.api.NPC setText(Player player, List<String> text);

    /**
     * @param text The text that all players will see. Null to remove
     * @return object instance
     */
    me.Abhigya.core.util.npc.npclib.api.NPC setText(List<String> text);
     ...
     * Use this method before using {@link me.Abhigya.core.util.npc.npclib.api.NPC#create}.
     *
     * @param location The spawn location for the NPC.
     * @return object instance.
     */
    me.Abhigya.core.util.npc.npclib.api.NPC setLocation(Location location);
     ...
     * @return object instance.
     */
    me.Abhigya.core.util.npc.npclib.api.NPC setSkin(Skin skin);
     ...
     * @return object instance.
     */
    me.Abhigya.core.util.npc.npclib.api.NPC create();
     ...
     * Requires {@link me.Abhigya.core.util.npc.npclib.api.NPC#create} to be used first.
     *
     ...
     * @return Object instance.
     */
    me.Abhigya.core.util.npc.npclib.api.NPC toggleState(NPCState state);
     ...
     * @return Object instance.
     */
    me.Abhigya.core.util.npc.npclib.api.NPC setItem(NPCSlot slot, ItemStack item);
