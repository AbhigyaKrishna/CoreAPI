...
public interface SpawnCustomizer {
    ...
    /**
     * Being called when a NPC was spawned for a certain player. Permanent NPC modifications should
     * be done in this method, otherwise they will be lost at the next respawn of the NPC.
