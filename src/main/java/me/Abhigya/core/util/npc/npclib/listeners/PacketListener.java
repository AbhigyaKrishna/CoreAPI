...
import me.Abhigya.core.util.npc.npclib.tinyprotocol.TinyProtocol;
...
public class PacketListener {
    ...
    private static final class TaskCallNpcInteractEvent implements Runnable {
        ...
        private me.Abhigya.core.util.npc.npclib.listeners.PacketListener listener;

        private static Location playerLocation = new Location(null, 0, 0, 0);

        TaskCallNpcInteractEvent(NPCInteractEvent eventToCall, me.Abhigya.core.util.npc.npclib.listeners.PacketListener listener) {
