package me.Abhigya.core.util.npc.npclib.nms.v1_16_R1;
...
import me.Abhigya.core.util.npc.npclib.nms.v1_16_R1.packets.*;
...
public class NPC_v1_16_R1 extends NPCBase {
    ...
    public Hologram getHologram(Player player) {
        ...
        if (holo == null) {
            holo = new Hologram(MinecraftVersion.V1_16_R1, location.clone().add(0, 0.5, 0), getText(player));
        }
