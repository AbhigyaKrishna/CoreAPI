...
public class RotationModifier extends NPCModifier {
    ...
    public RotationModifier queueRotate(float yaw, float pitch) {
        ...
        WrappedPacket entityHeadLookContainer =
                new WrappedPacketOutEntityHeadRotation(this.npc.getEntityId(), yawAngle);
        ...
        if (MINECRAFT_VERSION.isOlderThan(ServerVersion.v_1_9)) {
            ...
            bodyRotateContainer =
                    new WrappedPacketOutEntityTeleport(
            ...
            bodyRotateContainer =
                    new WrappedPacketOutEntity.WrappedPacketOutEntityLook(
                            this.npc.getEntityId(), yawAngle, pitchAngle, true);
        }
