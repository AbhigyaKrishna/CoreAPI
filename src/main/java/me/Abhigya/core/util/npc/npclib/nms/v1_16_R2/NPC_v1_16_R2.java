package me.Abhigya.core.util.npc.npclib.nms.v1_16_R2;
...
import me.Abhigya.core.util.npc.npclib.internal.MinecraftVersion;
import me.Abhigya.core.util.npc.npclib.internal.NPCBase;
import me.Abhigya.core.util.npc.npclib.nms.v1_16_R2.packets.*;
...
public class NPC_v1_16_R2 extends NPCBase {
    ...
    public Hologram getHologram(Player player) {
        ...
        if (hologram == null)
            hologram = new Hologram(MinecraftVersion.V1_16_R2, location.clone().add(0, 0.5, 0), getText(player));
