...
package me.Abhigya.core.util.npc.npclib.nms.v1_13_R2;
...
import me.Abhigya.core.util.npc.npclib.nms.v1_13_R2.packets.*;
...
public class NPC_v1_13_R2 extends NPCBase {
    ...
    public Hologram getHologram(Player player) {
        ...
        if (holo == null) {
            holo = new Hologram(MinecraftVersion.V1_13_R2, location.clone().add(0, 0.5, 0), getText(player));
        }
