...
/** Represents the item stacks whose type is wool, and allows to change its color easily. */
...
public class WoolItemStack extends CustomItemStack {
    ...
    public void setColor(WoolColor color) {
        ...
        Material wool_material =
                EnumReflection.getEnumConstant(Material.class, color.name() + "_WOOL");
    ...
    /** The durability of the wool item stack cannot be changed manually. */
