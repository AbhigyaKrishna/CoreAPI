...
public class TpsUtils {
    ...
    /**
     ...
     //	 * <p>
     //	 * @return current the ticks per seconds.
     //	 */
...
//		try {
//			return (double[]) FieldReflection.getValue ( ClassReflection.getNmsClass ( "MinecraftServer" ) , "recentTps" );
//		} catch (SecurityException | NoSuchFieldException | IllegalArgumentException | IllegalAccessException
//				| ClassNotFoundException ex ) {
//			throw new IllegalStateException ( "couldn't get current server ticks per second!" + ex.getMessage ( ) );
//		}
//	}
//
