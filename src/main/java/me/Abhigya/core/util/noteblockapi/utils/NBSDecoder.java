package me.Abhigya.core.util.noteblockapi.utils;

import me.Abhigya.core.util.noteblockapi.model.CustomInstrument;
...
public class NBSDecoder {
    ...
    private static Song parse(InputStream inputStream, File songFile) {
        ...
        try {
            ...
            firstcustominstrumentdiff =
                    InstrumentUtils.getCustomInstrumentFirstIndex() - firstcustominstrument;
            ...
            if (firstcustominstrumentdiff < 0) {
                ArrayList<CustomInstrument> customInstruments =
                        CompatibilityUtils.getVersionCustomInstrumentsForSong(
            ...
            Bukkit.getServer()
                    .getConsoleSender()
                    .sendMessage(ChatColor.RED + "Song is corrupted: " + file);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    private static void setNote(
            int layerIndex, int ticks, Note note, HashMap<Integer, Layer> layerHashMap) {
