...
public class TimeUtils {
     ...
     * @param format use:
     *     <ul>
     *       <li>hh for two-digit hours
     *       <li>h for one-digit hours
     *       <li>mm for two-digit minutes
     *       <li>m for one-digit minutes
     *       <li>ss for two-digit seconds
     *       <li>s for one-digit seconds
     *       <li>m for miliseconds (do not use without seconds, would be more than 4 digits)
     *     </ul>
     *
     * @param songPlayer
