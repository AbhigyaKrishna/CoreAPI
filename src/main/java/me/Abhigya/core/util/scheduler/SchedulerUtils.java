...
public class SchedulerUtils {
    ...
    public static int scheduleSyncRepeatingTask(
            Runnable task, long delay, long period, Plugin plugin) {
     ...
     * @throws IllegalArgumentException if task is null
     */
    public static void runTask(Consumer<BukkitTask> task, Plugin plugin)
     ...
     * @throws IllegalArgumentException if task is null
     */
    public static BukkitTask runTaskAsynchronously(Runnable task, Plugin plugin)
            throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if task is null
     */
    public static void runTaskLaterAsynchronously(
            Consumer<BukkitTask> task, long delay, Plugin plugin) throws IllegalArgumentException {
    ...
    public static void runTaskTimer(
            Consumer<BukkitTask> task, long delay, long period, Plugin plugin)
            throws IllegalArgumentException {
    ...
    public static BukkitTask runTaskTimerAsynchronously(
            Runnable task, long delay, long period, Plugin plugin) throws IllegalArgumentException {
