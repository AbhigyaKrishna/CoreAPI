package me.Abhigya.core.util.server;
...
public class LifePhase {
    ...
    /**
     * Returns the server's current life phase - when you call this in onEnable or onDisable, and it
     * returns RUNNING, it means the server is reloading.
     *
    ...
    public ServerLifePhase getLifePhase() {
        try {
            ...
            return ((boolean) isRunningMethod.invoke(nmsServer))
                    ? ServerLifePhase.RUNNING
                    : ServerLifePhase.SHUTDOWN;
