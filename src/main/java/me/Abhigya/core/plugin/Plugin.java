...
public abstract class Plugin extends JavaPlugin {
    ...
    public final void onEnable() {
        ...
        //            ConsoleUtils.sendPluginMessage( ChatColor.RED, "Obsolete core version! A core
     ...
     *
     * <p>This method might return <strong>{@code null}</strong> if no metrics is required.
     *
     * <p>
     *
     ...
     *
     * <p>A listener within the provided package will be registered only when the following
     * conditions are met:
     *
     * <ul>
    ...
    protected void setUpListenersPackage(String packaje)
        ...
        for (Class<? extends Listener> clazz :
                ClassReflection.getClasses(packaje, Listener.class)) {
            ...
            if (!out.exists() || replace) {
                try {
                    ...
                    ConsoleUtils.sendPluginMessage(
                            ChatColor.RED,
                            "Couldn't save resource " + resource_path + " to " + out,
                            this);
                    ex.printStackTrace();
                }
            }
