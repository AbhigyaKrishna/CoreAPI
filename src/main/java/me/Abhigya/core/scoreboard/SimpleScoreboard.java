...
public class SimpleScoreboard {
    ...
    public SimpleScoreboard(String title, String... initial_elements) {
        ...
        this.objective = handle.registerNewObjective(StringUtils.limit(UUID.randomUUID().toString(), MAX_NAME_LENGTH), "milo");
        this.objective.setDisplayName(StringUtils.limit(StringUtils.translateAlternateColorCodes(title), MAX_DISPLAYNAME_LENGTH));
    ...
    public void setTitle(String title) {
        objective.setDisplayName(StringUtils.limit(
                StringUtils.translateAlternateColorCodes(StringUtils.defaultIfBlank(title, "")), MAX_DISPLAYNAME_LENGTH));
    }
    ...
    public void update() {
        ...
        getViewers().stream().filter(viewer -> viewer != null).forEach(viewer -> {
...
//		this.update();
    ...
    public void set(int index, String text) {
        ...
        if (text == null) {
            ...
            this.elements[index] = StringUtils.limit(StringUtils.translateAlternateColorCodes(text), MAX_ELEMENTS_LENGTH);
        }
    }
     ...
     * @return Index of the next null/whitespace element, or -1 if no
