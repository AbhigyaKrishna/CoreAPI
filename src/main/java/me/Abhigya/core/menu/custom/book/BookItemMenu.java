package me.Abhigya.core.menu.custom.book;
...
public class BookItemMenu extends ItemMenu {
    ...
    /**
     * Returns the number of the page of this book that the given player is viewing,
...
//	}
    ...
    /**
     * Stores the given items only
     * if the menu is not full at the moment of
    ...
    /**
     * Stores the given bar button on the
     * given slot.
     * <p>
     *
    ...
    /**
     * Stores the given bar button item
