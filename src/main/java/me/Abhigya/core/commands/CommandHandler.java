...
/**
 * Convenience implementation of {@link CommandExecutor} and {@link TabCompleter}, for handling
 * {@link PluginCommand}s.
 */
public class CommandHandler extends PluginHandler implements TabCompleter, CommandExecutor {
    ...
    /**
     * Constructs the command handler for handling the provided {@link PluginCommand}, with the
     * desired {@link CommandArgument}.
     *
     * <p>
     *
    ...
    /**
     * Constructs the command handler for handling a {@link PluginCommand} of the provided {@link
     * JavaPlugin}, with the desired {@link CommandArgument}s.
     *
     * <p>
     *
     * @param plugin Plugin owner of the command.
     * @param name Name of the commmand described in the <strong>{@code plugin.yml}</strong> file.
     * @param arguments Arguments to handle.
     */
    public CommandHandler(
            final JavaPlugin plugin, final String name, final CommandArgument... arguments) {
