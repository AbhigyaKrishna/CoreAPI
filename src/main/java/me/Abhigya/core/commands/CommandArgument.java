...
public interface CommandArgument {
    ...
    /**
     * Executes this argument. Note that the {@code subargs} array might exclude the name of this
     * argument.
     *
     * <p>
     *
     ...
     * @param subargs Passed command arguments, excluding this, including final partial argument to
     *     be completed and command label.
     * @return List of possible completions for the final argument, or null to default to the
     *     command executor.
     */
